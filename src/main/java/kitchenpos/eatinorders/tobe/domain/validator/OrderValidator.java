...
public class OrderValidator {
    ...
    public void checkOrderLineItemQuantity(List<OrderLineItem> orderLineItems, OrderType orderType) {
    ...
    private boolean containsUnderZeroQuantity(List<OrderLineItem> orderLineItems) {
