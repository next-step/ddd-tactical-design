...
public class EatInOrderCompletedResponse {
    ...
    public static EatInOrderCompletedResponse from(EatInOrder order) {
    ...
    public EatInOrderCompletedResponse(OrderId id, EatInOrderStatus status, EatInOrderLineItems orderLineItems, OrderTableId orderTableId, LocalDateTime orderDateTime) {
        this.id = id;
        this.status = status;
