...
public class EatInOrderAcceptResponse {
    ...
    public EatInOrderAcceptResponse(OrderId id, EatInOrderStatus status, EatInOrderLineItems orderLineItems, OrderTableId orderTableId, LocalDateTime orderDateTime) {
        this.id = id;
        this.status = status;
