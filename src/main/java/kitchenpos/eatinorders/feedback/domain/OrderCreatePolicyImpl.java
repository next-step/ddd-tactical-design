...
@Component
public class OrderCreatePolicyImpl implements OrderCreatePolicy {
    private final OrderTableRepository orderTableRepository;
    private final MenuRepository menuRepository;

    public OrderCreatePolicyImpl(OrderTableRepository orderTableRepository, MenuRepository menuRepository) {
