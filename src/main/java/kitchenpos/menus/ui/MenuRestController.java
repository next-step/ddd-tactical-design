...
public class MenuRestController {
    ...
    @PostMapping
    public ResponseEntity<Menu> create(@RequestBody final MenuCreateRequestDto request) {
    ...
    public ResponseEntity<Menu> changePrice(@PathVariable final UUID menuId, @RequestBody final MenuPriceChangeRequestDto request) {
