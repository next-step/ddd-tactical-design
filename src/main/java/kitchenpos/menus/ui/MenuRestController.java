...
public class MenuRestController {
    ...
    @PostMapping
    public ResponseEntity<MenuDto> create(@RequestBody final MenuCreateRequest request) {
    ...
    public ResponseEntity<MenuDto> changePrice(@PathVariable final UUID menuId, @RequestBody final MenuPriceChangeRequest request) {
