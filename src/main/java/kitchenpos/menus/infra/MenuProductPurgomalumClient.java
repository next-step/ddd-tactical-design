...
@Component
public class MenuProductPurgomalumClient implements MenuPurgomalumClient {
    private final RestTemplate restTemplate;

    public MenuProductPurgomalumClient(final RestTemplateBuilder restTemplateBuilder) {
