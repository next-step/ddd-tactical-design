...
public class MenuDisplayResponse extends DTO {
    ...
    public MenuDisplayResponse() {
    }

    public MenuDisplayResponse(MenuId menuId, String name, BigDecimal price, MenuGroupId menuGroupId, List<TobeMenuProduct> menuProducts, boolean displayed) {
        this.menuId = menuId;
        this.name = name;
        this.price = price;
    ...
    public MenuDisplayResponse(TobeMenu menu) {
    ...
    public boolean equals(Object o) {
        ...
        MenuDisplayResponse menuDto = (MenuDisplayResponse) o;
