...
public class MenuPriceChangeResponse extends DTO {
    ...
    public MenuPriceChangeResponse(MenuId menuId, String name, BigDecimal price, MenuGroupId menuGroupId, MenuProducts menuProducts, boolean displayed) {
        this.menuId = menuId;
        this.name = name;
        this.price = price;
    ...
    public MenuPriceChangeResponse(TobeMenu menu) {
