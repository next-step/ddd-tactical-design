...
public class MenuDto {
    ...
    public MenuDto(MenuId menuId, String name, BigDecimal price, MenuGroupId menuGroupId, List<TobeMenuProduct> menuProducts, boolean displayed) {
        this.menuId = menuId;
        this.name = name;
        this.price = price;
