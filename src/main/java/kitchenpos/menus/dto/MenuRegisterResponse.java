...
public class MenuRegisterResponse extends DTO {
    ...
    public MenuRegisterResponse(MenuId menuId, String name, BigDecimal price, MenuGroupId menuGroupId, MenuProducts menuProducts, boolean displayed) {
        this.menuId = menuId;
        this.name = name;
        this.price = price;
