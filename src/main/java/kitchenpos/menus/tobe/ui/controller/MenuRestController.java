package kitchenpos.menus.tobe.ui.controller;
...
public class MenuRestController {
    ...
    @PostMapping
    public ResponseEntity<Menu> create(@RequestBody final MenuRequest.Create request) {
    ...
    public ResponseEntity<Menu> changePrice(@PathVariable final UUID menuId, @RequestBody final MenuRequest.ChangePrice request) {
