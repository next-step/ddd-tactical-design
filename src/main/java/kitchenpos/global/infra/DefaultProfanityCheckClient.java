...
@Component
public class DefaultProfanityCheckClient implements ProfanityCheckClient {
    private final RestTemplate restTemplate;

    public DefaultProfanityCheckClient(final RestTemplateBuilder restTemplateBuilder) {
