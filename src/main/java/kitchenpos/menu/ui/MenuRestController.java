...
public class MenuRestController {
	...
	@PostMapping
	public ResponseEntity<Menu> create(@RequestBody final MenuCreationRequest request) {
	...
	public ResponseEntity<Menu> changePrice(@PathVariable final UUID menuId,
		@RequestBody final BigDecimal requestPrice) {
		return ResponseEntity.ok(menuService.changePrice(menuId, requestPrice));
	}
