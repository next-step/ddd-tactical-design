package kitchenpos.deliveryorders.tobe.ui;

import kitchenpos.deliveryorders.tobe.application.DeliveryOrderService;
...
public class DeliveryOrderRestController {
    ...
    @PostMapping
    public ResponseEntity<DeliveryOrder> create(@RequestBody final DeliveryOrderRequest request) {
