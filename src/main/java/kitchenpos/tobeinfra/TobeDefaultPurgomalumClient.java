...
@Component
public class TobeDefaultPurgomalumClient implements TobePurgomalumClient {
    private final RestTemplate restTemplate;

    public TobeDefaultPurgomalumClient(final RestTemplateBuilder restTemplateBuilder) {
