...
public class ProductRestController {
    ...
    @PostMapping
    public ResponseEntity<Product> create(@RequestBody final ProductModel request) {
    ...
    public ResponseEntity<Product> changePrice(@PathVariable final UUID productId, @RequestBody final ProductModel request) {
