...
public class ProductRestController {
    ...
    @PostMapping
    public ResponseEntity<Product> create(@RequestBody final ProductCreateDto request) {
    ...
    public ResponseEntity<Product> changePrice(@PathVariable final UUID productId, @RequestBody final ProductPriceChangeDto request) {
