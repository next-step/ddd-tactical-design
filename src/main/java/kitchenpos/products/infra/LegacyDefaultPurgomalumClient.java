...
@Component
public class LegacyDefaultPurgomalumClient implements PurgomalumClient {
    private final RestTemplate restTemplate;

    public LegacyDefaultPurgomalumClient(final RestTemplateBuilder restTemplateBuilder) {
