...
@Component
public class DisplayNamePurgomalumClient implements DisplayNameChecker {
    private final RestTemplate restTemplate;

    public DisplayNamePurgomalumClient(final RestTemplateBuilder restTemplateBuilder) {
