...
insert into menu_group (id, productName)
...
insert into menu (id, displayed, productName, price, menu_group_id)
...
insert into order_table (id, occupied, productName, number_of_guests)
