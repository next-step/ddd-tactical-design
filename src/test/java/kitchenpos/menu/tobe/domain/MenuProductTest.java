...
class MenuProductTest {
    ...
    void success() {
        ...
        final var menuProduct = MenuProduct.of(product.getId(), product.getProductPrice().longValue(), 2);
    ...
    void menuProductFail3(final long input) {
        ...
        assertThrows(IllegalQuantityException.class, () -> MenuProduct.of(product.getId(), product.getProductPrice().longValue(), input));
    }
}
