...
public class ToBeFixtures {
    ...
    public static Menu menu(final long price, final boolean displayed, final MenuProduct... menuProduct) {
        ...
        return new Menu(new Price(BigDecimal.valueOf(price)), menuProducts, new MenuGroup(UUID.randomUUID(), new MenuGroupName("메뉴그룹")));
    }
    ...
    public static Product product(final String name, final long price) {
        return new Product(new DisplayedName(name, false), new Price(BigDecimal.valueOf(price)));
    }
