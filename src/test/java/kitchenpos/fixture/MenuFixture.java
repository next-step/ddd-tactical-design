...
public class MenuFixture {
    ...
    public static final String DOUBLE_FRIED_CHICKEN_MENU = "후라이드+후라이드";
    public static final BigDecimal CHICKEN_SET_MENU_PRICE = BigDecimal.valueOf(30_000L);
    public static final BigDecimal DOUBLE_FRIED_CHICKEN_MENU_PRICE = BigDecimal.valueOf(19_000L);
    ...
    public static Menu menu(final String name, final BigDecimal price, final MenuGroup menuGroup,
                            final List<MenuProduct> menuProducts, final boolean isDisplayed) {
        return menu(createMenuId(), name, price, menuGroup, menuProducts, isDisplayed);
    }
