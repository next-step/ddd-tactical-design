...
public class MenuFixture {
    ...
    public static Menu MENU1() {
        ...
        return new Menu(new DisplayedName("메뉴1", profanities), new Price(10000L), menuGroup, true, MENU_PRODUCTS());
    }

    public static Menu NOT_DISPLAYED_MENU() {
        final MenuGroup menuGroup = new MenuGroup(new DisplayedName("메뉴그룹1", profanities));
        return new Menu(new DisplayedName("메뉴1", profanities), new Price(10000L), menuGroup, false, MENU_PRODUCTS());
    }

    public static Menu MENU_WITH_PRICE(final long price) {
        final MenuGroup menuGroup = new MenuGroup(new DisplayedName("메뉴그룹1", profanities));
        return new Menu(new DisplayedName("메뉴1", profanities), new Price(price), menuGroup, true, MENU_PRODUCTS());
    }

    public static Menu NOT_DISPLAYED_MENU_WITH_PRICE(final long price) {
        final MenuGroup menuGroup = new MenuGroup(new DisplayedName("메뉴그룹1", profanities));
        return new Menu(new DisplayedName("메뉴1", profanities), new Price(price), menuGroup, false, MENU_PRODUCTS());
    }
