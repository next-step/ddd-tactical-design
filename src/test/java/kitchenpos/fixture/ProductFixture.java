...
public class ProductFixture {
    ...
    public static Product PRODUCT1() {
        return new Product(new DisplayedName(NAME1, profanities), new Price(PRICE1));
    }

    public static Product PRODUCT2() {
        return new Product(new DisplayedName(NAME2, profanities), new Price(PRICE2));
    }

    public static Product CHEAP_PRODUCT() {
        return new Product(new DisplayedName(NAME2, profanities), new Price(CHEAP_PRICE));
    }
    ...
    public static Product PRODUCT_WITH_NAME(final String name) {
        return new Product(new DisplayedName(name, profanities), new Price(PRICE1));
    }
