...
public class OrderTableTest {
    ...
    void create() {
        OrderTable 주문_테이블 = ToBeFixtures.emptyOrderTableOf("주문_테이블");
    ...
    void checkValidatedName(String name) {
        Assertions.assertThatThrownBy(
                () -> ToBeFixtures.emptyOrderTableOf(name)
    ...
    void sit() {
        OrderTable 빈_주문_테이블 = ToBeFixtures.emptyOrderTableOf("주문_테이블");
        빈_주문_테이블.sit();
    ...
    void changeNumberOfGuests() {
        OrderTable 주문_테이블 = ToBeFixtures.sitOrderTableOf("주문_테이블");
        int 변경_숫자 = 5;
    ...
    void changeNumberOfGuests_exception_emptyTable() {
        OrderTable 빈_테이블 = ToBeFixtures.emptyOrderTableOf("주문_테이블");
