...
import kitchenpos.eatinorders.tobe.InMemoryOrderTableRepository;
...
class OrderCreatePolicyTest {
    ...
    void create() {
        ...
        assertDoesNotThrow(() -> orderCreatePolicy.create(orderLineItems, 일번테이블.getId()));
    }
    ...
    void createWithWrongPrice() {
        ...
        assertThatThrownBy(() -> orderCreatePolicy.create(orderLineItems, 일번테이블.getId()))
