...
import kitchenpos.menus.tobe.domain.MenuPricePolicy;
import kitchenpos.menus.tobe.domain.MenuRepository;
import kitchenpos.menus.tobe.domain.ProductTotalPricePolicy;
...
class OrderServiceTest {
    ...
    void setUp() {
        ...
        menuPricePolicy = (price, menu) -> false;
    ...
    void createDeliveryOrder() {
        final UUID menuId = menuRepository.save(menu(19_000L, true, menuPricePolicy, menuProduct())).getId();
    ...
    void createNotDisplayedMenuOrder() {
        final UUID menuId = menuRepository.save(menu(19_000L, false, menuPricePolicy, menuProduct())).getId();
        final Order expected = createOrderRequest(OrderType.TAKEOUT, createOrderLineItemRequest(menuId, 19_000L, 3L));
        assertThatThrownBy(() -> orderService.create(expected))
            .isInstanceOf(IllegalStateException.class);
    }
