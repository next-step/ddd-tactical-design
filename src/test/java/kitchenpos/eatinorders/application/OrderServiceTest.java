...
//        orderService = new OrderService(orderRepository, new MenuRepository(), orderTableRepository, kitchenridersClient);
//    }
//
//    @DisplayName("1개 이상의 등록된 메뉴로 배달 주문을 등록할 수 있다.")
//    @Test
//    void createDeliveryOrder() {
//        final UUID menuId = menuRepository.save(new ToBeMenu(19_000L, true, menuProduct())).getId();
...
//        final UUID menuId = menuRepository.save(new ToBeMenu(19_000L, false, menuProduct())).getId();
//        final Order expected = createOrderRequest(OrderType.TAKEOUT, createOrderLineItemRequest(menuId, 19_000L, 3L));
//        assertThatThrownBy(() -> orderService.create(expected))
//            .isInstanceOf(IllegalStateException.class);
//    }
