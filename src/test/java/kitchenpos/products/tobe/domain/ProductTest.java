    ...
    class 등록할_수_있다 {
        ...
        void 이름이_비어있다면_등록할_수_없다(String value) {
            assertThatIllegalArgumentException()
                .isThrownBy(() -> new Product(UUID.randomUUID(), new DisplayedName(value, POLICY), 1000));
        }
        ...
        void 이름이_비어있지_않고_가격이_0원_이상이라면_등록할_수_있다(String nameValue, long price) {
            assertDoesNotThrow(() -> new Product(UUID.randomUUID(), new DisplayedName(nameValue, POLICY), price));
        }
    }
