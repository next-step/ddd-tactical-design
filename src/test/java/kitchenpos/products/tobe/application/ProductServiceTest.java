...
class ProductServiceTest {
    ...
    void changePriceInMenu() {
        final Product product = productRepository.save(createProductRequest("후라이드", 16_000L));
        final Menu menu = menuRepository.save(menu(19_000L, true, createMenuProduct(product, 2L)));
