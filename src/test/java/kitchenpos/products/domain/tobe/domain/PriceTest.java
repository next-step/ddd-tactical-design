...
class PriceTest {
    ...
    @Test
    void changePrice() {
        var price = Price.of(30_000L);
        var newPrice = price.changePrice(30_001L);
        assertThat(newPrice.isSamePrice(Price.of(30_001L))).isTrue();
    }
    ...
    void isGreaterThan1() {
        var price = Price.of(30_000L);
        assertThat(price.isGreaterThan(Price.of(29_999L))).isTrue();
    }
    ...
    void isGreaterThan2(long value) {
        var price = Price.of(30_000L);
        assertThat(price.isGreaterThan(Price.of(value))).isFalse();
    }

    @DisplayName("상품가격을 더하면 합계 상품 금액을 확인 할 수 있다.")
    @Test
    void addPrice() {
        var price1 = Price.of(30_000L);
        var price2 = Price.of(10_000L);
        assertThat(price1.add(price2)).isEqualTo(Price.of(40_000L));
    }
