...
class MenuProductServiceTest {
    ...
    public void init() {
        ...
        MenuProductRequest p1Request = new MenuProductRequest(product1Uuid, BigDecimal.valueOf(10_000), 1);
        MenuProductRequest p2Request = new MenuProductRequest(product2Uuid, BigDecimal.valueOf(20_000), 1);
        MenuProductRequest p3Request = new MenuProductRequest(product3Uuid, BigDecimal.valueOf(30_000), 1);
    ...
    | Product3   | 30,000원 |
     ...
     | 메뉴   | 가격     | 가지고 있는 제품        |
     |--------|----------|---------------------------|
     | Menu1  | 20,000원 | Product1, Product2       |
     | Menu2  | 50,000원 | Product2, Product3       |
