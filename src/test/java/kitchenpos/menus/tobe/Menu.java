...
public class Menu {
    ...
    public Menu(final UUID id, final String name, final long price, final MenuGroup menuGroup, final List<MenuProduct> menuProducts, final boolean displayed) {
        this(id, name, new MenuPrice(price), menuGroup, menuProducts, displayed);
    }

    public Menu(final UUID id, final String name, final MenuPrice price, final MenuGroup menuGroup, final List<MenuProduct> menuProducts, final boolean displayed) {
        this.id = id;
        this.name = name;
        this.price = price;
