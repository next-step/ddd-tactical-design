...
import kitchenpos.menus.tobe.menu.infra.InMemoryMenuRepository;
import kitchenpos.menus.tobe.menu.infra.MenuProductApiCaller;
...
class MenuServiceTest {
    ...
    void changePrice() {
        ...
        assertThat(actual.getPrice()).isEqualTo(MenuFixture.메뉴(1_000L, menuGroup, menuProducts).getPrice());
    }
