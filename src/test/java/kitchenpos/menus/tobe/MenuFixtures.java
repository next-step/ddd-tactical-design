...
public class MenuFixtures {
    public static final Long MENU_TWO_FRIED_CHICKENS_ID = 1L;
    public static final Long MENU_ONE_FRIED_CHICKENS_ID = 2L;
    public static final Long MENUGROUP_TWO_CHICKENS_ID = 1L;
    public static final Long MENUGROUP_ONE_CHICKENS_ID = 2L;
    ...
    public static Menu menuTwoFriedChickens() {
        ...
        ReflectionTestUtils.setField(menu, "id", MENU_TWO_FRIED_CHICKENS_ID);
        return menu;
    }

    public static Menu menuOneFriedChicken() {
        final Menu menu = new Menu("후라이드", BigDecimal.valueOf(10_000L), MENUGROUP_ONE_CHICKENS_ID, Arrays.asList(menuProduct()));
        ReflectionTestUtils.setField(menu, "id", MENU_ONE_FRIED_CHICKENS_ID);
        return menu;
    }
    ...
    public static MenuGroup menuGroupOneChicken() {
        final MenuGroup menuGroup = new MenuGroup("한마리메뉴");
        ReflectionTestUtils.setField(menuGroup, "id", MENUGROUP_TWO_CHICKENS_ID);
        return menuGroup;
    }
