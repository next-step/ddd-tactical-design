...
class PricePolicyImplTest {
    ...
    void changeMenuProductPriceWithEqualsMenuPriceAndMenuProductTotalPrice(long changePrice) {
        ...
        pricePolicy.changePrice(product, ProductPrice.from(BigDecimal.valueOf(changePrice)));
    ...
    void changeMenuProductPriceWithMenuPriceBiggerThanMenuProductTotalPrice() {
        ...
        pricePolicy.changePrice(product, ProductPrice.from(BigDecimal.valueOf(14_999L)));
