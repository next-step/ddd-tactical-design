...
//        menuService = new MenuService(toBeMenuRepository, menuGroupRepository, toBeProductRepository, purgomalumClient);
//        menuGroupId = menuGroupRepository.save(menuGroup()).getId();
//        product = toBeProductRepository.save(new Product("후라이드", BigDecimal.valueOf(16_000L),purgomalumClient));
//    }
//
