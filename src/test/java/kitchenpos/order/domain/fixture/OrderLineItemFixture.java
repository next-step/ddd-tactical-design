...
public record OrderLineItemFixture(UUID 메뉴아이디, UUID 주문아이디, long 주문수량, BigDecimal 주문가격) {
    ...
    public static OrderLineItemFixture init(UUID orderId) {
    ...
    public static OrderLineItemFixture test(UUID 메뉴아이디, UUID 주문아이디, long 주문수량, BigDecimal 주문가격) {
        return new OrderLineItemFixture(
            메뉴아이디,
            주문아이디,
    ...
    public OrderLineItem toEntity() {
        return new OrderLineItem(MenuId.of(메뉴아이디), OrderId.of(주문아이디), OrderLineItemQty.of(주문수량), 주문가격);
    }
