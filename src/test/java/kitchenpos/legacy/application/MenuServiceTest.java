...
import kitchenpos.legacy.external.domain.PurgomalumClient;
import kitchenpos.legacy.fake.FakePurgomalumClient;
import kitchenpos.legacy.fixture.MenuFixture;
import kitchenpos.legacy.fixture.MenuGroupFixture;
import kitchenpos.legacy.fixture.MenuProductFixture;
import kitchenpos.legacy.fixture.ProductFixture;
import kitchenpos.legacy.menu.application.MenuService;
import kitchenpos.legacy.menu.domain.model.Menu;
import kitchenpos.legacy.menu.domain.model.MenuGroup;
import kitchenpos.legacy.menu.domain.model.MenuProduct;
...
import kitchenpos.legacy.repository.InMemoryMenuGroupRepository;
import kitchenpos.legacy.repository.InMemoryMenuRepository;
import kitchenpos.legacy.repository.InMemoryProductRepository;
