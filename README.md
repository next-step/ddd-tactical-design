...
- **주문이 완료된 경우, 주문 테이블을 정리한다.**
  - [x] 주문 테이블이 존재해야 한다.
  - [ ] 주문 상태가 `완료` 인 경우 해당 손님 수를 `0`으로 설정하고, 테이블 사용 여부를 `사용 가능` 상태로 변경한다.
...
| 한글명      | 영문명           | 설명                                                                                                                                     |
|----------|---------------|----------------------------------------------------------------------------------------------------------------------------------------|
| 주문    | TakeOutOrder  | 배달하는 고객 대상. 집이나 직장 등 고객이 선택한 주소로 음식을 배달한다.                                                                                              |
...
| 한글명     | 영문명            | 설명                                                                                                                                                                      |
|---------|----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 주문    | DeliveryOrder  | 포장하는 고객 대상. 고객이 매장에서 직접 음식을 수령한다.                                                                                                                                       |
