...
- [x][x] 상품이 없으면 등록할 수 없다.
- [x][ ] 메뉴에 속한 상품의 수량은 0 이상이어야 한다.
- [x][x] 메뉴의 가격이 올바르지 않으면 등록할 수 없다.
  - [x][x] 메뉴의 가격은 0원 이상이어야 한다.
- [x][x] 메뉴에 속한 상품 금액의 합은 메뉴의 가격보다 크거나 같아야 한다.
- [x][x] 메뉴는 특정 메뉴 그룹에 속해야 한다.
- [x][x] 메뉴의 이름이 올바르지 않으면 등록할 수 없다.
  - [x][ ] 메뉴의 이름에는 비속어가 포함될 수 없다.
  - [x][x] 메뉴의 이름에는 null 이나 공백일 수 없다.
- [x][x] 메뉴의 가격을 변경할 수 있다.
- [x][x] 메뉴의 가격이 올바르지 않으면 변경할 수 없다.
  - [x][x] 메뉴의 가격은 0원 이상이어야 한다.
- [x][x] 메뉴를 노출할 수 있다.
