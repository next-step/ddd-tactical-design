...
- **주문을 완료할 수 있다.**
  ...
  - [ ] 주문 유형이 `포장` 이면 주문 상태가 `서빙 완료` 여야 한다.
  - [x] 주문 유형이 `매장 내 식사` 이면 주문 상태가 `주문 완료` 로 변경한다.
...
| 한글명        | 영문명           | 설명                                                                                                                                     |
|------------|---------------|----------------------------------------------------------------------------------------------------------------------------------------|
| 포장 주문      | TakeOutOrder  | 배달하는 고객 대상. 집이나 직장 등 고객이 선택한 주소로 음식을 배달한다.                                                                                              |
...
| 한글명        | 영문명            | 설명                                                                                                                                                                      |
|------------|----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 배달 주문      | DeliveryOrder  | 포장하는 고객 대상. 고객이 매장에서 직접 음식을 수령한다.                                                                                                                                       |
