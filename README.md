...
| 숨기다    | display            | 메뉴를 숨기는 행위                 |
| 노출하다   | hite               | 메뉴를 보이는 행위                 |
...
| 사용중 테이블 | occupied order table | 시용 중인 주문 테이블                                       |
| 사용하다    | sit                  | 주문 테이블을 사용 중으로 바꾸는 행위                              |
| 치우다     | clear                | 주문 테이블을 빈 테이블로 바꾸는 행위                              |
| 주문 항목   | order line item      | 주문에 속하는 수량이 있는 메뉴                                  |
| 주문한 메뉴  | orderd menu          | 주문한 시점의 메뉴 정보(가격, 메뉴 이름)                           |
